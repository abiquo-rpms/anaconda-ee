...
class AbiquoHandlers(KickstartHandlers):
    def __init__(self, ksdata):
        KickstartHandlers.__init__(self, ksdata)
        self.resetHandlers()
        self.handlers["abiquo-server"] = self.doAbiquoServer
        self.handlers["abiquo-remote-services"] = self.doAbiquoRemoteServices

    def doAbiquoRemoteServices(self, args):
        pass
    
    def doAbiquoServer(self, args):
        pass
