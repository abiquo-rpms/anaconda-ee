...
#Patch2: anaconda-frameos-installclasses-2.patch
#Patch3: anaconda-centos-regkey.patch
Patch4: anaconda-frameos-frameos-branding-po_files.patch
...
Patch9: anaconda-frameos-lang-table.patch
#Patch10: anaconda-frameos-disable-language-gui.patch
...
%changelog
* Wed Jan 11 2012 Sergio Rubio <srubio@abiquo.com> - 11.1.2.242-200.1.abiquo
- bumped version

* Mon Dec 19 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-200.1.abiquo
- bumped release 

* Fri Jul 8 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-180.2.abiquo
- bumped release 

* Mon May 30 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-180.1.abiquo
- 1.8 bump

* Thu Mar 31 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-175.7.abiquo
- FIX: fixes in 1.7.5 upgrade 
...
* Fri Mar 04 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.24.abiquo
- updated release string in /etc/motd

* Thu Mar 03 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.23.abiquo
- dhcp relay profile fixes and improvements
- write new remote services properties for netapp storage plugin

* Wed Mar 02 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.22.abiquo
- fixed ontap profile post-install actions

* Mon Jan 31 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.21.abiquo
- fixed ontap profile post-install actions
...
* Fri Jan 27 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.18.abiquo
- changed xml config migration script
...
* Fri Jan 21 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.13.abiquo
- fixes in ciab profile

* Thu Jan 20 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.12.abiquo
- minor fixes

* Thu Jan 20 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.11.abiquo
- fixes in multiple profiles
- Added abiquo-nfs-repository profile

* Wed Jan 19 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.10.abiquo
- minor fixes

* Wed Jan 19 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.9.abiquo
- minor fixes

* Wed Jan 19 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.8.abiquo
- minor fixes

* Wed Jan 19 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.7.abiquo
- minor fixes

* Tue Jan 18 2011 Sergio Rubio <srubio@abiquo.com> - 11.1.2.195-170.6.abiquo
- minor fixes
...
- updated text installer for 1.7
- 1.7 minor changes
- include installer info in /etc/abiquo-installer
- no longer use /etc/sysconfig/abiquo* files
- Added VirtualBox Cloud Node profile
...
* Thu Sep 02 2010 Sergio Rubio <srubio@abiquo.com> 11.1.2.195-4.abiquo
- Add Abiquo customizations

* Thu Sep 02 2010 Sergio Rubio <srubio@abiquo.com> 11.1.2.195-3.abiquo
- Roll in AbiquoOS Patch set

* Tue Jul 06 2010 Sergio Rubio <srubio@abiquo.com> 11.1.2.195-2.el5.abiquo
- Roll in AbiquoOS Patch set
